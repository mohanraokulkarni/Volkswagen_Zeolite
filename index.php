    ...
    <header>
      <nav>
        <div class="nav__header">
          <div class="nav__logo">
            <a href="#">
              <img src="assets/logo.png" alt="Volkswagen Logo" class="logo"/>Volkswagen</a>
          </div>
        ...
        <div class="nav__btns">
          <a href="signup.html"><button class="btn btn__primary">Sign Up</button></a>
          <a href="login.html"><button class="btn btn__secondary">Sign In</button></a>
        </div>
      </nav>
      <div class="section__container header__container" id="home">
        <div class="header__image">
          <img src="car.gif" alt="header" />
        </div>
  ...
  function showPreviousNotifications() {
    ...
    <section class="section__container service__container" id="service">
      <div class="service__image">
        <img src="carrr1.png" alt="service" />
      </div>
      ...
      <div class="section__container footer__container">
        <div class="footer__col">
          <div class="footer__logo">
            <a href="#" class="logo">
              <img src="assets/logo.png" alt="Volkswagen Logo" />
